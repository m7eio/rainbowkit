...
```bash
npm i @m7eio/rainbowkit@^0.4.0 wagmi@^0.5.0
```
...
```bash
npm i @m7eio/rainbowkit@^0.2.0 wagmi@^0.4.2
```
...
```diff
- import { configureChains } from '@m7eio/rainbowkit';
...
```diff
- import { apiProvider } from '@m7eio/rainbowkit';
```
