...
You can import individual wallets from `'@m7eio/rainbowkit/wallets'` along with the `connectorsForWallets` function to build your own list of wallets with their necessary connectors. This way you have full control over which wallets to display, and in which order.

For example, you can choose to only show Rainbow along with generic fallback wallets.

```tsx
import { connectorsForWallets } from '@m7eio/rainbowkit';
import {
  injectedWallet,
  rainbowWallet,
  walletConnectWallet,
...
```tsx
import { walletConnectWallet } from '@m7eio/rainbowkit/wallets';
...
```tsx
import { injectedWallet } from '@m7eio/rainbowkit/wallets';
...
```tsx
import { argentWallet } from '@m7eio/rainbowkit/wallets';
...
```tsx
import { braveWallet } from '@m7eio/rainbowkit/wallets';
...
```tsx
import { coinbaseWallet } from '@m7eio/rainbowkit/wallets';
...
```tsx
import { ledgerWallet } from '@m7eio/rainbowkit/wallets';
...
```tsx
import { metaMaskWallet } from '@m7eio/rainbowkit/wallets';
...
```tsx
import { omniWallet } from '@m7eio/rainbowkit/wallets';
...
```tsx
import { rainbowWallet } from '@m7eio/rainbowkit/wallets';
...
```tsx
import { trustWallet } from '@m7eio/rainbowkit/wallets';
...
```tsx
import { imTokenWallet } from '@m7eio/rainbowkit/wallets';
