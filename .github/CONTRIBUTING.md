...
- Select the latest version tag for `@m7eio/rainbowkit`.
- Set the title to `@m7eio/rainbowkit@x.x.x` (substituting the latest version)
...
- Go to [GitHub’s new release form.](https://github.com/rainbow-me/rainbowkit/releases/new)
- Select the latest version tag for `@m7eio/rainbowkit-siwe-next-auth`.
- Set the title to `@m7eio/rainbowkit-siwe-next-auth@x.x.x` (substituting the latest version)
...
- Go to [GitHub’s new release form.](https://github.com/rainbow-me/rainbowkit/releases/new)
- Select the latest version tag for `@m7eio/create-rainbowkit`.
- Set the title to `@m7eio/create-rainbowkit@x.x.x` (substituting the latest version)
